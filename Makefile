...
.DEFAULT_GOAL := help
.PHONY: greet blog calculator hello middleware help
project := greet calculator blog hello middleware
...
clean: clean_greet clean_calculator clean_blog clean_middleware ## Clean generated files
	${RM_F_CMD} ssl/*.crt
	${RM_F_CMD} ssl/*.csr
	${RM_F_CMD} ssl/*.key
	${RM_F_CMD} ssl/*.pem
...
clean_hello: ## Clean generated files for blog
	${RM_F_CMD} hello/${PROTO_DIR}/*.pb.go

clean_middleware: ## Clean generated files for middleware
	${RM_F_CMD} middleware/${PROTO_DIR}/*.pb.go
